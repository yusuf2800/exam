...
export const metadata = {
  title: "Tuition Program - GCSE Foundation",
};

const Page = () => {
  const questions = [
    [
      { question: 1, answer: ["A", "B", "C", "D"], correct: ["C"] },
      { question: 2, answer: ["A", "B", "C", "D"], correct: ["B"] },
    ...
    [
      ...
      { question: 9, answer: ["A", "B", "C", "D"], correct: ["B"] },
      { question: 10, answer: ["A", "B", "C", "D"], correct: ["D"] },
    ],
    [
      { question: 11, answer: ["A", "B", "C", "D"], correct: ["A"] },
      { question: 12, answer: ["A", "B", "C", "D"], correct: ["D"] },
      { question: 13, answer: ["A", "B", "C", "D"], correct: ["C"] },
      { question: 14, answer: ["A", "B", "C", "D"], correct: ["A"] },
      { question: 15, answer: ["A", "B", "C", "D"], correct: ["B"] },
    ],
    [
      { question: 16, answer: ["A", "B", "C", "D"], correct: ["D"] },
      { question: 17, answer: ["A", "B", "C", "D"], correct: ["C"] },
      { question: 18, answer: ["A", "B", "C", "D"], correct: ["B"] },
      { question: 19, answer: ["A", "B", "C", "D"], correct: ["A"] },
      { question: 20, answer: ["A", "B", "C", "D"], correct: ["C"] },
    ],
    [
      { question: 21, answer: ["A", "B", "C", "D"], correct: ["B"] },
      { question: 22, answer: ["A", "B", "C", "D"], correct: ["B"] },
      { question: 23, answer: ["A", "B", "C", "D"], correct: ["A"] },
      { question: 24, answer: ["A", "B", "C", "D"], correct: ["D"] },
      { question: 25, answer: ["A", "B", "C", "D"], correct: ["C"] },
    ],
  ];
